# Generated by Django 4.1.7 on 2023-04-24 08:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_for_trainer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='report_for_trainer', to='golfApp.trainer')),
                ...
                ('report_from_trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='report_from_trainer', to='golfApp.trainer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='golfApp.trainer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='golfApp.trainer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='golfApp.subplan')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=150)),
                ('subplan', models.ManyToManyField(to='golfApp.subplan')),
            ],
        ),
        migrations.CreateModel(
            name='PlanDiscount',
            fields=[
                ...
                ('subplan', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='golfApp.subplan')),
            ],
        ),
        migrations.CreateModel(
            name='Notify',
            fields=[
                ...
                ('read_by_trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='golfApp.trainer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notif', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='golfApp.notify')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.BooleanField(default=False)),
                ('notif', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='golfApp.trainernotification')),
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='golfApp.trainer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallery', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='golfApp.gallery')),
            ],
        ),
        migrations.CreateModel(
